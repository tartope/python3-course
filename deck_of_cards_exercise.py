...
class Deck:
    ...
    def _deal(self, num):
        ...
        # if the deck has 0 cards in it, return the error message
        if count == 0:
        ...
        # use slice, start from negative actual all the way to the end to remove cards
        cards = self.cards[-actual:]
        # update self.cards so it goes from the beginning of the list, up to what was just removed
    ...
    # use import statement at the top
    def shuffle(self):
        if self.count() < 52:
...
hand2 = deck.deal_hand(50)
card2 = deck.deal_card()
print(card2) #//=>  6 of Diamonds
print(deck.cards) #//=> [] 
card2 = deck.deal_card() #//=>  All cards have been dealt